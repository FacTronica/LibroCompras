...
$Detalle["CodImp"]["1"]["1"]="27"; 			// Codigo del Impuesto adicional: Ej. Cod.26 Iva Cervezas 
$Detalle["TasaImp"]["1"]["1"]="20.5"; 			// Tasa de impuesto Ej. 20.5%
$Detalle["MntImp"]["1"]["1"]="2050"; 			// Monto del impuesto Ej. 2050 ( Calculado en base a un neto de $10.000 )
$Detalle["CodImp"]["1"]["2"]="19"; 			// Codigo del Impuesto adicional: Ej. Cod.19 Iva Anticipado Harina
$Detalle["TasaImp"]["1"]["2"]="12"; 			// Tasa de impuesto por ej. 12%
$Detalle["MntImp"]["1"]["2"]="12000"; 			// Monto del impuesto por ej. 12000 ( Calculado en base a un neto de $100.000 )
...
$TotalesPeriodo["TotMntImp"]["33"]["1"]="2050"; 	// monto total del impuesto
$TotalesPeriodo["CodImp"]["33"]["2"]="19"; 		// codigo tipo de impuesto
$TotalesPeriodo["TotMntImp"]["33"]["3"]="12000"; 	// monto total del impuesto
